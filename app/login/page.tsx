  ...
  return (
    <>
      <style>{`
        ...
        .lp-nav-logo span { font-size:19px; font-weight:800; letter-spacing:0.22em; text-transform:uppercase; color:var(--cream); }
        .lp-nav-links { display:flex; gap:36px; }
        .lp-nav-right { display:flex; align-items:center; width:107px; justify-content:flex-end; }
        .lp-nav-link { position:relative; font-size:17px; font-weight:600; letter-spacing:0.16em; text-transform:uppercase; color:var(--muted); transition:color .2s; }
        ...
        <main className="lp-main">
          ...
          <div className={`lp-card ${visible ? "visible" : ""}`}>
            <div className="lp-card-inner">
              ...
              {mode === "login" && (
                <button className="lp-forgot" type="button" onClick={handleResetPassword}>Forgot your password?</button>
              )}
