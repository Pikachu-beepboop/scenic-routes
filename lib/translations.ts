...
"footer.link.sendFeedback":     { en: "Send Feedback",         de: "Feedback senden",          ru: "Отправить отзыв" },
...
// ==================== Explore-Seite ====================
  ...
  // Support-Tab — Contact/Feedback-Einleitungstexte
  "profile.support.contact.intro":  { en: "Have a question or need help? Just send us an email:", de: "Hast du eine Frage oder brauchst Unterstützung? Schreib uns einfach eine E-Mail:", ru: "Есть вопрос или нужна помощь? Просто напишите нам на почту:" },
  "profile.support.feedback.intro": { en: "We'd love to hear your feedback, ideas, or bug reports — just email us:", de: "Wir freuen uns über dein Feedback, Ideen oder Fehlermeldungen — schreib uns einfach:", ru: "Будем рады вашим отзывам, идеям или сообщениям об ошибках — просто напишите нам:" },

  // Support-Tab — FAQ-Einträge (Fragen & Antworten)
  "profile.support.faq.q1": { en: "How do I save a route to “My Trips”?", de: "Wie speichere ich eine Route in „My Trips“?", ru: "Как сохранить маршрут в «My Trips»?" },
  "profile.support.faq.a1": { en: "Open a route and tap the bookmark icon. It will then appear in your “My Trips” section.", de: "Öffne eine Route und tippe auf das Lesezeichen-Symbol. Sie erscheint danach in deinem Bereich „My Trips“.", ru: "Откройте маршрут и нажмите на значок закладки. После этого он появится в разделе «My Trips»." },
  "profile.support.faq.q2": { en: "Can I use Explore Scenic Routes offline?", de: "Kann ich Explore Scenic Routes offline nutzen?", ru: "Можно ли пользоваться Explore Scenic Routes офлайн?" },
  "profile.support.faq.a2": { en: "You currently need an internet connection to load routes and maps. An offline mode is planned.", de: "Aktuell benötigst du eine Internetverbindung, um Routen und Karten zu laden. Eine Offline-Funktion ist in Planung.", ru: "Сейчас для загрузки маршрутов и карт нужно подключение к интернету. Офлайн-режим планируется добавить позже." },
  "profile.support.faq.q3": { en: "How do I change my account details?", de: "Wie ändere ich meine Kontodaten?", ru: "Как изменить данные своего аккаунта?" },
  "profile.support.faq.a3": { en: "Go to Settings → Account → Profile, where you can edit your display name, country, and more.", de: "Gehe zu Settings → Account → Profile, dort kannst du deinen Anzeigenamen, dein Land und weitere Angaben bearbeiten.", ru: "Перейдите в Settings → Account → Profile — там можно изменить имя профиля, страну и другие данные." },
  "profile.support.faq.q4": { en: "How do I delete my account?", de: "Wie lösche ich mein Konto?", ru: "Как удалить свой аккаунт?" },
  "profile.support.faq.a4": { en: "In Settings → Account → Profile, you'll find the “Danger Zone” with the option to permanently delete your account.", de: "Unter Settings → Account → Profile findest du im Bereich „Danger Zone“ die Option, dein Konto dauerhaft zu löschen.", ru: "В разделе Settings → Account → Profile, в блоке «Danger Zone», есть опция окончательного удаления аккаунта." },
